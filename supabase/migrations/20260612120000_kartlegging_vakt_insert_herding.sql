-- Sikkerhetsreview-funn: kunde-INSERT kunne saa inn rad med ferdig
-- assessment/mockup_path/kunde_sett_at. Frys dem ved innsending (genereringen
-- skriver dem senere via lovlig statusovergang genererer->forslag_klart).
-- Identisk med 20260612080000-funksjonen ellers. Kjoert mot prod 2026-06-12.
